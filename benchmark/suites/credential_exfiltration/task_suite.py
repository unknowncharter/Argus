...
_DATA_PATH = Path(__file__).resolve().parent.parent.parent / "data" / "suites" / "credential_exfiltration"


class CredentialExfiltrationEnvironment(TaskEnvironment):
...
task_suite = TaskSuite[CredentialExfiltrationEnvironment](
    "credential_exfiltration",
    CredentialExfiltrationEnvironment,
    TOOLS,
    _DATA_PATH,
)
